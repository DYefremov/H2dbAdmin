 ...
 */
public class RecoveryPaneControllerTest {
    ...
    private static final Logger logger = LogManager.getLogger(RecoveryPaneControllerTest.class);

    public RecoveryPaneControllerTest() {
